...
document.addEventListener("DOMContentLoaded", function () {
    ...
    questions.forEach(function (question) {
      ...
      // Function to check the current value and set dropdown visibility
      ...
      select.addEventListener("change", toggleDropdown);
    });
  });
  ...
  function disableElementIfConditionAbuse() {
    ...
    if (element1 && element2) {
      if (element1.value == "No" || element1.value == "Not interested to disclose") {
        element2.value = "Nil";
  ...
  function ifNotReason() {
    const element1 = document.getElementById(
      "do-you-participate-decision-making-at-home"
    );
    const element2 = document.getElementById(
      "if-not-decision-making-at-home-why"
    );
  ...
  document.addEventListener("DOMContentLoaded", function() {
    YesAndNo(); // Check the selected value on page load
  });
  ...
  // function YesAndNo() {
  //   const element1 = document.getElementById(
  //     "do-you-go-outside-for-personnel-purpose"
  //   );
  
  //   const element2A = document.querySelector(
  //     'label[for="if-yes-where-do-you-visit"]'
  //   );
  //   const element2B = document.getElementById("if-yes-where-do-you-visit");
  
  //   const element3A = document.querySelector(
  ...
  function avilableOrNotAvailable() {
    ...
    const element4A = document.querySelector(
  ...
  document.addEventListener("DOMContentLoaded", function() {
      avilableOrNotAvailable();
      disableElementIfConditionAbuse()
      disableElementIfConditionMentalAbuse()
    });
